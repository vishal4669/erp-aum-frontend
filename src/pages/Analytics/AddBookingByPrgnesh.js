...
function AddBooking(props) {
  ...
  const handleInputChange = (e, index) => {
    ...
    for (let i = 0; i < arr_len; i++) {
      ...
      console.log("last_index_child",last_index_child);
      // var child;
      if (i >= 1) {
        if (testData[i]['parent_child'] == 'Parent') {
          parent = parent + 1;
          ...
          // console.log("last_index_parent",last_index_parent);
          // var child =  0.1;
          // console.log("==============",last_index_child);
          // var lastparentno = testData[last_index_parent]['p_sr_no'];
          // let lastChildno = testData[last_index_child]['p_sr_no'];
    ...
    console.log("final Array", testData);
    setTestData(list);
    set_p_sr_no(testData);
