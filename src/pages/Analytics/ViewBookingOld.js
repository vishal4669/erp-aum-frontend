...
const edit_booking_id =url.substring(url.lastIndexOf('/') + 1)
  ...
  const [customer,setCustomer] = useState({customer_company_name:''})
      ...
      {setLoading1(true)}
        axios.get(`${process.env.REACT_APP_BASE_APIURL}getBooking/`+booking_id,{headers})
            .then(response => {
                ...
                setCustomer(response.data.data.customer_company_name)
                                            ...
                                            <div className="row">
                                              <div className="col-md-3">
                                                <label>Customer</label>
                                                  <input className="form-control" value={customer.customer_company_name} type="text"  readOnly/>
                                               </div>
